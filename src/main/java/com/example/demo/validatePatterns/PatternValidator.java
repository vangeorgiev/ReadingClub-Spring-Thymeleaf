...
public class PatternValidator {
	//User
		public static final String name = "^[A-Z]{1}[a-z]{1,15}$";
		...
		public static final String  username = "[A-Za-z]{2,15}";
		//TODO validate password
		public static final String password = "^(?=.*[A-Za-z])(?=.*\\d)(?=.*[@$!%*#?&])[A-Za-z\\d@$!%*#?&]{8,}$";
		public static final String contact = "^.{10,250}$";
		public static final String roleEnum = "(?<role>\\w+(?=\\,|\\s))";
		public static final String url = "^(http:\\/\\/|https:\\/\\/)?(www.)?([a-zA-Z0-9]+).[a-zA-Z0-9]*.[a-z]{3}.?([a-z]+)?$";
